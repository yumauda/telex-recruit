...
<head>
    ...
    <?php elseif (is_page('recruit')) : ?>
        <title>採用情報｜テレックス関西</title>
        <meta name="description" content="テレックス関西の採用情報ページです。" />
        <meta name="keywords" content="テレックス関西,採用情報" />
        <meta property="og:title" content="採用情報｜テレックス関西" />
        <meta property="og:type" content="article">
        <meta property="og:url" content="https://telex.com/recruit">
        <meta property="og:image" content="<?php echo get_template_directory_uri() ?>/images/common/ogp.jpg" />
            ...
            <div class="p-header__content">
                <h1 class="p-header__logo">
                    <a href="#" class="p-header__link">
                        <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/common/header_logo.png" alt="テレックス関西" width="100" height="100">
                    </a>
                </h1>
            </div>
        </div>
